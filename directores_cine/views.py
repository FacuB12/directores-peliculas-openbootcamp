...
def listar_directores(request):
    ...
    return render(request, 'directores.html', {'directores': directores, 'pagina': 'directores', 'titulo': 'Directores'})
...
def listar_peliculas(request):
    ...
    return render(request, 'peliculas.html', {'peliculas': peliculas, 'pagina': 'peliculas', 'titulo': 'Peliculas'})
